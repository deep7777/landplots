    ...
    <script src="{{ asset('/js/plugins/date-time-moment.js') }}"></script>
    <script src="{{ asset('/bower_components/seiyria-bootstrap-slider/dist/bootstrap-slider.min.js') }}"></script>
    <script src="{{ asset('/bower_components/seiyria-bootstrap-slider/dependencies/js/highlight.min.js') }}"></script>
    <script src="{{ asset('/bower_components/php-date-formatter/js/php-date-formatter.js') }}"></script>
    <script src="{{ asset('/bower_components/datetimepicker/jquery.datetimepicker.js') }}"></script>
    <script src="{{ asset('/bower_components/jquery-simply-countable/jquery.simplyCountable.js') }}"></script>
    <script src="{{ asset('/bower_components/bootstrap3-dialog/dist/js/bootstrap-dialog.min.js') }}"></script>
    <script src="{{ asset('/bower_components/panorama_viewer/jquery.panorama_viewer.min.js') }}"></script>
