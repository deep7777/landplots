            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-handshake-o"></i>Partners<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{url('/listPartners')}}">List</a></li>
                    </ul>
                  </li>
                  <li>
                    <a><i class="fa fa-users"></i> {{ trans('dashboard.user_management') }}<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li id="add_customer"><a href="{{url('/admin/listStaff')}}">{{ trans('dashboard.list') }}</a></li>                   
                    </ul>
                  </li>
                </ul>
              </div>
            ...
            <nav class="" role="navigation">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  <a title="Plot Payment Reminder" href="{{url('/reports/listPaymentReminders')}}"  aria-expanded="false">
