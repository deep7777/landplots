...
<form id="frm_partner" action ="{{url('/addSitePartner')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
{{ csrf_field() }}
    ...
    <div class="x_panel">
      <div class="form-group col-xs-12">
        <div class="x_title">
          ...
          <div class="pull-right">
            <a type="button" class="btn-xs btn-primary" href="{{url('/listPartners')}}">Back</a>
          </div>
          <div class="clearfix"></div>
        </div>
      </div>
      ...
      <div class="x_content">
        ...
        <div class="form-group col-xs-12">
          ...
          <input required="" id="partner_first_name" name="partner_first_name" value="" class="form-control clear-all"  type="text"/>
          </div>
          <div class="form-group col-md-4">
          <label class="control-label requiredField" for="middle_name">
           Middle Name
          </label>
          <input id="partner_middle_name" name="partner_middle_name"  value=""  class="form-control clear-all"  type="text"/>
          </div>
          <div class="form-group col-md-4">
           <label class="control-label requiredField" for="last_name">
            Last Name
           </label>
            <input id="partner_last_name" name="partner_last_name" required="" value="" class="form-control clear-all"  type="text"/>
          </div>
        </div>
        <div class="form-group col-xs-12">
          <div class="form-group col-md-4">
          ...
          <input required="" id="partner_mobile_no" name="partner_mobile_no" value="" class="form-control clear-all"  type="text"/>
          </div>
          <div class="form-group col-md-4">
          <label class="control-label requiredField" for="partner_email_id">
           Email Id
          </label>
          <input id="partner_email_id" name="partner_email_id"  value=""  class="form-control clear-all"  type="email"/>
          </div>
        </div>
        <div class="form-group col-xs-12">
          <div class="form-group col-md-4">
          ...
          <input required=""  id="partner_percentage" name="partner_percentage" value="" class="form-control red clear-all partner_amount"  type="text"/>
          </div>
          <div class="form-group col-md-4">
          <label class="control-label requiredField" for="partner_amount">
           Amount
          </label>
          <input id="partner_amount" name="partner_amount"  value=""  class="form-control blue clear-all partner_amount" 
                 />
          </div>
        </div>
        <div class="form-group col-xs-12">
        <div class="form-group col-md-4">
           ...
           <textarea required="" class="form-control" cols="40" id="partner_address" name="partner_address" rows="4"></textarea>
          </div>
        </div>  
        <div class="clearfix col-xs-12"></div>
        <div class="pull-right">
