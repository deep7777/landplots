...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form id="frm_expense" action ="{{url('/expenses')}}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
        {{ csrf_field() }}
        <div class="form-group col-xs-12">
          ...
          <input required="" id="expense_given_to" name="expense_given_to" value="" class="form-control "  type="text"/>
          </div>
          <div class="form-group col-md-4">
        ...
        <div class="form-group col-xs-12">
          ...
          Bill No
            ...
            <input id="expense_bill_no" name="expense_bill_no" value="" class="form-control" type="text"/>
          </div>
          <div class="form-group col-md-4">
